// js/render.js
import { getOwnedItems, getCurrentItemType, getGlobalEffectModes, getArtifactDB, getSlateDB, getDBItem, getState } from './state.js'; // 수정됨
...
export function renderInventoryGrid() {
    ...
    const { inventory: inventoryState, slotCount } = getState(); // 수정됨
...
function updateSelectedItems() {
    ...
    const { inventory: inventoryState, globalEffectModes } = getState(); // 수정됨
