...
import { getDBItem, getSlateDB, getState } from './state.js';
...
export function calculateAllBuffs() {
    const { inventory: currentInventory, slotCount } = getState();
